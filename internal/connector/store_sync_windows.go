...
func syncConnectorDirectory(path string) error {
	...
	if flushErr == windows.ERROR_INVALID_FUNCTION || flushErr == windows.ERROR_INVALID_HANDLE || flushErr == windows.ERROR_NOT_SUPPORTED {
		flushErr = nil
	}
