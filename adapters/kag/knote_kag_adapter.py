...
def generate_kag_config(path: Path, params: dict[str, Any]) -> None:
    ...
    openie_llm_api_key = quoted_config(config_setting(params, "openie_llm_api_key", "KNOTE_OPENIE_LLM_API_KEY", "ollama"))
    ...
    chat_llm_api_key = quoted_config(config_setting(params, "chat_llm_api_key", "KNOTE_CHAT_LLM_API_KEY", "ollama"))
    ...
    vector_api_key = quoted_config(config_setting(params, "vector_api_key", "KNOTE_VECTOR_API_KEY", "ollama"))
